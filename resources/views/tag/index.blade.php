                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <table id="example2" class="table table-bordered table-hover dataTable"
                                            ...
                                            <tbody>
                                                @foreach ($dataTag as $tag=>$hasil)
                                                <tr>
                                                    <th>{{$tag + $dataTag->firstitem() }}</th>
                                                    <td>{{$hasil->nama}}</td>
                                                    <td>{{$hasil->slug}}</td>
                                                    <td>
                                                        <a href="/tag/{{$hasil->id}}/edit" class="btn btn-warning">Edit</a>
                                                        <a href="/tag/{{$hasil->id}}/destroy" class="btn btn-danger" onclick="return confirm ('Yakin Mau Dihapus ?')">Delete</a>
                                                    </td>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">DATA TAG</h5>
